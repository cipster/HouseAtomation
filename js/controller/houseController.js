define('HouseController', ['jquery', 'SvgService', 'LightService', 'CurtainService', 'TemperatureService'],
    function ($, SvgService, LightService, CurtainService, TemperatureService) {
